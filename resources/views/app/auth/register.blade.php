{{-- resources/views/app/auth/register.blade.php --}}
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="{{ route('app.login') }}" class="font-medium text-blue-600 hover:text-blue-500">
            ...
            <form class="mt-8 space-y-6" action="{{ route('app.register') }}" method="POST">
                @csrf
